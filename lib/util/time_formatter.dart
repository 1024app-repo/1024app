...
String formatTime(int timestamp) {
  ...
  return !result.startsWith("刚刚") ? result + '前' : result;
}
...
String countSeconds(int difference) {
  ...
  return count > 1 ? count.toString() + ' 秒' : '刚刚';
}
